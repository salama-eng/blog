...
<?php
	...
	<section class="main-content-w3layouts-agileits">
		<div class="container">
			<h3 class="tittle"><?php $id=$_GET["id"];
$result =$db_obj->select('departments')->where("id",$id)->runQuery() ;
 echo $result[0]->title;
 ?>
...
<?php
$id=$_GET["id"];
$result =$db_obj->select('posts')->where("dep_id",$id)->orderby("date")->runQuery();
foreach($result as $row)
{
...
?>
						...
						<div class="col-md-6 card">
							<a href="single.html">
								<img src="images/<?=$row->imag?>" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								...
								<p class="card-text mb-3"><?=$row->paragraph?></p>
